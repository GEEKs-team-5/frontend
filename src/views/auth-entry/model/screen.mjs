export const getNextScreen = (screen, action) => {
  ...
  if (screen === 'signup-role' && action === 'select-guardian') return 'signup-guardian';
  if (screen === 'signup-role' && action === 'select-patient') return 'signup-profile';
  if (screen === 'signup-profile' && action === 'next') return 'signup-invite';
  ...
  if (screen === 'signup-guardian' && action === 'go-back') return 'signup-role';
